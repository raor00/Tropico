...
const DISC = {
  buyShares: Buffer.from([0xa9, 0x1a, 0x39, 0x9b, 0x5c, 0x72, 0x8c, 0x22]),
  claimReward: Buffer.from([0x2d, 0xb5, 0x71, 0x5d, 0x82, 0x35, 0xc9, 0xf0]),
  vote: Buffer.from([0x18, 0x67, 0x21, 0xc5, 0x2d, 0xb3, 0x88, 0x3a]),
};
